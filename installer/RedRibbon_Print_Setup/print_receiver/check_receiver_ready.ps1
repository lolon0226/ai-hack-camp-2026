# RedRibbon Print Receiver 준비 상태 점검
$ErrorActionPreference = "Continue"
$root = "C:\RedRibbonPrint"
$output = Join-Path $root "RedRibbon_Printer_Output"
...
$printerName = "RedRibbon Printer"

Write-Host "=== RedRibbon Print Receiver 점검 ===" -ForegroundColor Cyan
...
if ($printer) {
    ...
    Write-Host "[WARN] Windows 프린터 '$printerName' 없음 (가상프린터 설치 후 확인)" -ForegroundColor Yellow
}
